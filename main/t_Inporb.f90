  subroutine t_Inporb(input_filename)
        use trexio

        implicit none
        character*(64) :: input_filename
       ! character*(64) :: filename   !  cas de S3
       ...
       !  call getarg(1, input_filename)
        !!filename='poc-trexio-b1/'//trim(input_filename)   !! cas de S3
        output_filename = 'INPORB'

        ! Ouverture du fichier
        !!trexio_file=trexio_open(trim(filename), 'r', TREXIO_AUTO, rc) !! cas de S3
