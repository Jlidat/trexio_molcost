...
trexioMain_5d: trexioMain.o trexio_module.o trexio2info_5d.o trexio2inporb.o trexio2mono.o 
	$(FC) -o $@ $(FCFLAGS) $^ $(LIBS)

trexioMain: trexioMain.o trexio2info.o trexio_module.o trexio2inporb.o trexio2mono.o 
	$(FC) -o $@ $(FCFLAGS) $^ $(LIBS)
