...
!    subroutine t_Info(input_filename) 
      ...
      !character*(64) :: filename !! nom du bucket S3 poc-trexio-b1/
...
!Déclaration explicite de la subroutine maj(str,n)
   ...
   !  filename='poc-trexio-b1/'//trim(input_filename) !Dans le cas de S3
      !Ouverture du fichier input :

   !   trexio_file = trexio_open(trim(filename), 'r', TREXIO_AUTO, rc)    ! le cas de S3
